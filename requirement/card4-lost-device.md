...
전부 헤드리스 브라우저로 실제 계정에 실제 패스키 두 개(서로 다른 가상 인증기 = 서로 다른 기기처럼 동작)를 등록해서 캡처했습니다. (2026-09-10 프론트엔드 리디자인 이후 새 계정 `auto-evidence-1-jqw3nozm`으로 다시 캡처 — 백엔드는 그대로라 동작은 동일합니다.)
...
```
등록 직후: passkeys = [ {"nickname":"자동화 테스트 기기 A", "created_at":"2026-09-10T03:05:05.866Z"} ]
두 번째 기기 추가 후: passkeys = [
  {"nickname":"자동화 테스트 기기 A", "created_at":"2026-09-10T03:05:05.866Z"},
  {"nickname":"두 번째 기기",         "created_at":"2026-09-10T03:05:10.370Z"}
]
```
